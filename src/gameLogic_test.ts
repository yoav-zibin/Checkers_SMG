describe('gameLogic unit tests:', function () {
  ...
  let WHITE_TURN_INDEX = 0;
  let BLACK_TURN_INDEX = 1;
  let WHITE_WIN_SCORES = [1, 0];
  let BLACK_WIN_SCORES = [0, 1];
  ...
  * 7:odd    ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--']]
  */
  let mandatoryJumpForBlack: Board = [
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
      ['--', 'DS', '--', 'WM', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'BK', '--', 'DS', '--', 'DS', '--'],
  ...
  /*
      ...
      * 7:odd    ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--']]
      */
  let mandatoryJumpForWhite: Board = [
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
      ['--', 'DS', '--', 'BK', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'WM', '--', 'DS', '--', 'DS', '--'],
  ...
  function checkAiService(board: Board, playerIndex: number) {
    // Also check aiService
    let start = new Date().getMilliseconds();
    let move = aiService.createComputerMove(board, playerIndex, {maxDepth: 2});
  ...
  function expectMegaMove(
    ...
    let move: IMove = gameLogic.createMove(boardBeforeMove, miniMoves, turnIndexBeforeMove);
  ...
  function expectMove(
      ...
      turnIndexAfterMove: number,
      endMatchScores: number[]): void {
    expectMegaMove(turnIndexBeforeMove, boardBeforeMove,
      [{fromDelta: fromDelta, toDelta: toDelta}], boardAfterMove, turnIndexAfterMove, endMatchScores);
  }
  ...
  */
  ...
  it("[1, 0] -> [2, 1] -> [3, 2]", function () {
    ...
    /*
      ...
      *       specific test.
      */
  let terminateTurnAfterCrowning: Board = [
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
  ...
  let terminateTurnAfterCrowningForKing: Board = [
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
      ['--', 'DS', '--', 'DS', '--', 'DS', '--', 'DS'],
      ['DS', '--', 'DS', '--', 'DS', '--', 'DS', '--'],
...
let endGameForBlack2: Board = [
  ...
  it('Sample game', function () {
    ...
    let movesNum = moves.length;
    expect(movesNum).toBe(46*2 + 1); // Black 46th move ends the game.
    for (let move of moves) {
      let fromDelta = idToDelta(move[0]);
      let toDelta = idToDelta(move[1]);
      let m = gameLogic.createMove(board, [{fromDelta: fromDelta, toDelta: toDelta}], turn);
      board = m.state.board;
      turn = m.turnIndex;
    }
